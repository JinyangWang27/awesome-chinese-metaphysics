...
- [lunar-java](https://github.com/6tail/lunar-java) - Comprehensive Java library for the Chinese lunar calendar, solar terms, stem-branch, and almanac data.
...
- [lunar-mcp-server](https://github.com/AngusHsu/lunar-mcp-server) - Model Context Protocol server exposing Chinese lunar calendar, solar terms, and auspicious-date tools to AI assistants.
...
- [Lunar-Solar-Calendar-Converter](https://github.com/isee15/Lunar-Solar-Calendar-Converter) - Lunar/solar (农历/公历) date converter for 1900–2100 with C#, Java, Python, JavaScript, and Go implementations.
